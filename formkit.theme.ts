...
/**
  ...
  *
  * @checksum - c2fd63d6b977ad31fbb67e5d38f1295d6a155aeb4f016682be8b730bfbba95a0
  * @variables - radius=rounded-lg,accentColor=orange,colorTemperature=neutral,spacing=2.5,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=400,inputMaxWidth=max-w-[24em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
